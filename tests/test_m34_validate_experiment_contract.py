...
EXPECTED_SHA256 = "920d19a7401830ec00ca2364e5175710af5202cc9dd8bf3512a254cbcaa18970"
...
class M34ValidateExperimentContractTests(unittest.TestCase):
    def test_exact_contract_passes_and_registers_hash(self):
        ...
        self.assertEqual(receipt["status"], "PASS_EXACT_R0_CONTRACT")
    ...
    def test_hash_or_scientific_parameter_drift_fails_closed(self):
        ...
        for path, value, expected in (
            ...
            (("mosaics", "seeds", "R0_VALID"), 1, "R0 seeds differ"),
