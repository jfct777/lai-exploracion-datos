...
workflow {
    ...
    def provenance = [
        ...
        prereg_amendment  : 'P1A-PRE-A1-OUTER-PROJECTABILITY',
        amendment_status  : 'PRE_AMENDED_BEFORE_OUTCOMES',
        prior_aborted_run : 'p1a-continuous-dev-20260819a; no outcome metrics observed',
        projectability_gate: 'outer only; three TRAIN folds as calibrated in preflight',
