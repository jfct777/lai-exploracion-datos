#!/usr/bin/env python3
"""Authenticate the complete M33 asset-manifest contract against one Git commit."""
...
def main() -> int:
    ...
    require(not dirty.strip(), "authenticated M33 asset sources are dirty or untracked")
    hashes = {}
